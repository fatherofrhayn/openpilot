...
def get_T_FOLLOW(custom_personalities=False, aggressive_follow=1.00, standard_follow=1.25, relaxed_follow=1.50, personality=log.LongitudinalPersonality.standard):
  if custom_personalities:
    if personality==log.LongitudinalPersonality.relaxed:
